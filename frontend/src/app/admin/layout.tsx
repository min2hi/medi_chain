      ...
      <div className="min-h-screen bg-slate-950 flex flex-col">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <nav className="w-56 bg-slate-900 border-r border-slate-800 flex flex-col overflow-y-auto shrink-0">
            ...
            <div className="px-3 py-3 border-t border-slate-800 space-y-3.5">
              <div>
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-2.5 py-2 text-xs text-red-405 hover:text-red-300 bg-red-950/20 hover:bg-red-950/40 border border-red-900/30 rounded-lg transition-all"
              >
